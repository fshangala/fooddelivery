        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-br from-primary-100 to-secondary-100 p-6">
            <div className="max-w-xl text-center">
                ...
                <div className="space-x-4">
                    <a href='/register' className="inline-block px-6 py-3 rounded-md font-semibold text-white bg-linear-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 transition">
                        Get Started
                    </a>

...
export default async function TermsOfUsePage() {
    ...
    const page = await PageService.getBySlug(supabase, 'terms-of-use');
    ...
    return (
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 lg:p-12">
            <header className="mb-12 text-center">
                ...
                <p className="text-gray-500 italic">Last updated: {new Date(page.updated_at || 0).toLocaleDateString()}</p>
